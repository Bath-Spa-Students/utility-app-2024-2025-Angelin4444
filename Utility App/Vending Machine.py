...
#also puting an inventory telling how many products are left in the machine.

product_info = [
    {"productId": 0, "product": "Princles 🍟", 'productPrice': 7, 'Stock Left': 10},
    {"productId": 1, "product": "Lays 🍪", 'productPrice': 5, 'Stock Left': 5},
    {"productId": 2, "product": "Cheetos 🌶️", 'productPrice': 5, 'Stock Left': 8},
    {"productId": 3, "product": "Fanta 🧃", 'productPrice': 2, 'Stock Left': 12},
    {"productId": 4, "product": "7up 🍶", 'productPrice': 2, 'Stock Left': 6},
    {"productId": 5, "product": "Coke 🥤", 'productPrice': 2, 'Stock Left': 4},
    {"productId": 6, "product": "Mars 🍫", 'productPrice': 4, 'Stock Left': 7},
    {"productId": 7, "product": "Twix 🍬", 'productPrice': 4, 'Stock Left': 5},
    {"productId": 8, "product": "Protein Bars 💪", 'productPrice': 5, 'Stock Left': 9},
    {"productId": 9, "product": "Water 💧", 'productPrice': 1, 'Stock Left': 15},
    {"productId": 10, "product": "Cold Tea 🍵", 'productPrice': 3, 'Stock Left': 10},
    {"productId": 11, "product": "Cold Coffee ☕", 'productPrice': 3, 'Stock Left': 8},
]
#Helps in creating neat tables 
table = PrettyTable() #(Creates the table aligning all the products into one)
table.field_names = ["Product", "Price (Dhs)", "Code No.", "Stock Left"] #(Helps to give neat headings)
for product in product_info:
    table.add_row([product["product"], product["productPrice"], product["productId"], product["Stock Left"]]) #(adding rows back to back)
